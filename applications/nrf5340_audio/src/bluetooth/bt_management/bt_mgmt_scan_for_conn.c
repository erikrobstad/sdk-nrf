...
/**
 * @brief	Check advertising data for matching device name
 *
 * @param	data		The advertising data to check
 * @param	user_data	The user data will contain pointer to the address
 *
 * @return	false to signify that we should stop going through adv data, true to continue
 */
...
/**
 * @brief	Scan receive callback when scanning for connections
 *
 * @param	info	LE advertisement and scan response packet information
 * @param	ad	Received advertising data
 */
